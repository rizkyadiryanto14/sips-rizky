        ...
        <form action="update-home-template" enctype="multipart/form-data" id="form_update" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="carousel_subtitle1" class="form-control"
                            value="<?= $carousel_subtitle1; ?>">
                    </div>
                    <div class="form-group">
                        <label>Title 1:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="carousel_description1" rows="8"
                            class="form-control"><?= $carousel_description1; ?></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Sub-Title 2"</label>
                        <input type="text" name="carousel_subtitle2" class="form-control"
                            value="<?= $carousel_subtitle2; ?>">
                    </div>
                    <div class="form-group">
                        <label>Title 2:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="carousel_description2" rows="8"
                            class="form-control"><?= $carousel_description2; ?></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Sub-Title 3"</label>
                        <input type="text" name="carousel_subtitle3" class="form-control"
                            value="<?= $carousel_subtitle3; ?>">
                    </div>
                    <div class="form-group">
                        <label>Title 3:</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="carousel_description3" rows="8"
                            class="form-control"><?= $carousel_description3; ?></textarea>
                    </div>
                </div>
            </div>
            <hr>
            ...
            <div class="row mb-3">
                <div class="col-md-4 col-xs-12">
                    ...
                    <input type="hidden" name="def_timeline" value="<?= $timeline; ?>">
                    <input class=form-control type="file" name="timeline">
                </div>
            </div>

            <h3>Uploud Panduan Skripsi</h3>
            <div class="row mb-3">
                <div class="col-md-4 col-xs-12">
                    <label>Panduan Skripsi </label>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input name="tentang_kami_subtitle" type="text" class="form-control"
                            value="<?= $tentang_kami_subtitle; ?>">
                    </div>
                    <div class="form-group">
                        <label>Isi : </label>
                        <textarea rows="10" class="form-control"
                            name="tentang_kami_isi"><?= $tentang_kami_isi; ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="social_description" class="form-control"
                            rows="5"><?= $social_description; ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
