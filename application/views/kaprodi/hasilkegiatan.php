    ...
    call('api/proposal_mahasiswa').done(function(res) {
        ...
        if (res.data) {
            res.data.forEach(obj => {
                if (obj.status == '1') {
                    proposal_mahasiswa += `<option value="` + obj.id + `">` + obj.judul +
                        `</option>`;
                }
            })
        }
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        return '<a href="' + base_url + '/cdn/vendor/hasil_kegiatan/kegiatan/' +
                            data + '" title="File Hasil" target="_blank" class="btn btn-success btn-sm">\
                ...
                },
                {
                    ...
                    render: function(data) {
                        return `
                            ...
                            data.id + `" data-file="` + data.file + `" data-file_kegiatan="` +
                            data.file_kegiatan + `" data-kegiatan="` + data.kegiatan + `">
