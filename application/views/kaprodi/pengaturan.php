            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <img src="<?= base_url() ?>cdn/img/mahasiswa/default.png"
                            style="max-height: 100%; max-width: 100%; width: 100%" class="icongambar">
                    </div>
                    <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="informasi" rows="7" class="form-control summernote"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="off" name="smtp_host" id="smtp_host" class="form-control"
                            required value="<?= $de->smtp_host; ?>">
                    </div>
                    <div class="form-group">
                        <label for="smtp_port">SMTP Port</label>
                        <input type="text" autocomplete="off" name="smtp_port" id="smtp_port" class="form-control"
                            required value="<?= $de->smtp_port; ?>">
                    </div>
                    <div class="form-group">
                        <label for="account_gmail">Akun Mail</label>
                        <input type="email" autocomplete="off" name="smtp_user" id="account_gmail" class="form-control"
                            required value="<?= $de->email; ?>">
                    </div>
                    <div class="form-group">
                        <label for="pass_gmail">Password Mail</label>
                        <input type="password" autocomplete="off" name="smtp_password" id="pass_gmail"
                            class="form-control" required value="<?= $de->password; ?>">
                    </div>
    ...
    function show() {
        call('api/pengaturan').done(function(res) {
            if (res.error == true) {
                ...
                $('img.icongambar').attr('src', base_url + 'cdn/img/icons/' + (res.data.icon ? res.data
                    .icon : 'default.png'));
            }
        })
    }
