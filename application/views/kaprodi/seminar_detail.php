    ...
    function show() {
        call('api/seminar/details/' + seminar_id).done(function(res) {
            if (res.error == true) {
                ...
                $('.persetujuan').html(`<a href="` + base_url + `cdn/vendor/persetujuan/` + res.data
                    .persetujuan + `">` + res.data.persetujuan + `</a>`);
                $('.file_proposal').html(`<a href="` + base_url + `cdn/vendor/file_proposal/` + res.data
                    .file_proposal + `">` + res.data.file_proposal + `</a>`);
                $('.sk_tim').html(`<a href="` + base_url + `cdn/vendor/sk_tim/` + res.data.sk_tim +
                    `">` + res.data.sk_tim + `</a>`);
                $('.bukti_konsultasi').html(`<a href="` + base_url + `cdn/vendor/bukti_konsultasi/` +
                    res.data.bukti_konsultasi + `">` + res.data.bukti_konsultasi + `</a>`);
