                    ...
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="dashboard.html">
                                <img
                                    src="<?= base_url() ?>cdn/img/icons/<?= $app->icon ? $app->icon : 'default.png' ?>">
                            </a>
                        </div>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="<?= base_url() ?>home"
                            class="nav-link <?= (strtolower($title) == 'home') ? "active" : "" ?>">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url() ?>home/cek"
                            class="nav-link <?= (strtolower($title) == 'cek') ? "active" : "" ?>">
                            <span class="nav-link-inner--text">Login Mahasiswa</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?= base_url() ?>auth/login"
                            class="nav-link <?= (strtolower($title) == 'cek') ? "active" : "" ?>">
                            <span class="nav-link-inner--text">Login sekpro/dosen</span>
                        </a>
                    </li>
                </ul>
                <hr class="d-lg-none" />
