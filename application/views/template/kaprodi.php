            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <!-- <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() ?>kaprodi/penelitian">
                        ...
                        <!-- <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() ?>kaprodi/hasilkegiatan">
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>kaprodi/report">
                                <i class="fa fa-book-open text-danger"></i>
                                <span class="nav-link-text">Report</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url() ?>kaprodi/pengaturan">
                        ...
                        <div class="col-lg-6 col-7">
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    <li class="breadcrumb-item"><a href="<?= base_url() ?>kaprodi/dashboard"><i
