                ...
                <form id="login">
                    <div class="form-group mb-3">
                        <div class="input-group input-group-merge input-group-alternative">
                            ...
                            <input class="form-control" name="nim" autocomplete="off" placeholder="Nim" type="text">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group input-group-merge input-group-alternative">
                            ...
                            <input class="form-control" name="password" autocomplete="off" placeholder="Password"
                                type="password">
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $(document).on('submit', 'form#login', function(e) {
        e.preventDefault();
        call('api/authMahasiswa/login', $(this).serialize()).done(function(req) {
            console.log(req);
            if (req.error == true) {
                ...
                notif(req.message, 'success').then(function() {
                    // window.location = base_url + 'authMahasiswa/cek/' + req.data.id +
                    //     '/' + req
                    //     .data.level;
                    window.location = base_url + 'authMahasiswa/cek/' + req.data.id +
                        '/3';
