...
<head>
    ...
    <link rel="icon" href="<?= base_url() ?>cdn/img/icons/<?= ($app->icon) ? $app->icon : 'default.png' ?>"
        type="image/png">
...
<body>
    ...
    <header id="slider-area">
        <nav class="navbar navbar-expand-md fixed-top scrolling-navbar bg-white">
            <div class="container">
                <img class="imgSize" src="<?= base_url() ?>cdn/img/icons/<?= $app->icon ? $app->icon : 'default.png' ?>"
                    alt="icon">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        <li class="nav-item mt-1">
                            <a class="nav-link page-scroll" href="<?= base_url('home/download') ?>">Panduan
                                Skripsi</a>
                        </li>
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption text-left">
                            <h3 class="wow fadeInRight" data-wow-delay="0.2s"><?= $carousel_subtitle1; ?></h1>
                                ...
                                <a href="<?= $carousel_btn_href1; ?>"
                                    class="btn btn-lg btn-common btn-effect wow fadeInRight"
                                    data-wow-delay="0.9s"><?= $carousel_btn_text1; ?></a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption text-center">
                            <h3 class="wow fadeInRight" data-wow-delay="0.2s"><?= $carousel_subtitle2; ?></h1>
                                ...
                                <a href="<?= $carousel_btn_href2; ?>"
                                    class="btn btn-lg btn-common btn-effect wow fadeInRight"
                                    data-wow-delay="0.9s"><?= $carousel_btn_text2; ?></a>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="overlay"></div>
                        ...
                        <div class="carousel-caption text-center">
                            <h3 class="wow fadeInRight" data-wow-delay="0.2s"><?= $carousel_subtitle3; ?></h1>
                                ...
                                <a href="<?= $carousel_btn_href3; ?>"
                                    class="btn btn-lg btn-common btn-effect wow fadeInRight"
                                    data-wow-delay="0.9s"><?= $carousel_btn_text3; ?></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="item-boxes services-item wow fadeInDown shadow border-0" data-wow-delay="0.2s">
                        <img width="80%" src="<?= base_url('assets/essence/img/timeline/') . $timeline; ?>"
                            alt="timeline">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                        ...
                        <ul class="footer-social">
                            ...
                            <li><a class="twitter" href="<?= $link_twitter; ?>"><i class="lni-twitter-filled"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-mb-12">
