            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        return '<a href="' + base_url + 'cdn/vendor/penelitian/' + data +
                            '">' + data + '</a>';
                    }
                },
                {
                    ...
                    render: function(data) {
                        if (data) {
                            return '<a href="' + base_url +
                                'cdn/vendor/penelitian/file_seminar/' + data + '">' + data +
                                '</a>';
                        } else {
                ...
                },
                {
                    ...
                    render: function(data) {
                        if (data) {
                            return '<a href="' + base_url +
                                'cdn/vendor/penelitian/sk_tim/' + data + '">' + data +
                                '</a>';
                        } else {
                            return '<span class="badge badge-danger">Belum Tersedia</span>';
                        }
                ...
                },
                {
                    ...
                    render: function(data) {
                        if (data) {
                            return '<a href="' + base_url +
                                'cdn/vendor/penelitian/bukti_konsultasi/' + data + '">' +
                                data + '</a>';
                        } else {
                            return '<span class="badge badge-danger">Belum Tersedia</span>';
                        }
                ...
                },
                {
                    ...
                    render: function(data) {
                        ...
                        <div class="text-center">
                            <a href="` + base_url + `admin/penelitian/detail/` + data.id +
