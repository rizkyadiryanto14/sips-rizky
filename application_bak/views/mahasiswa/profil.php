            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nim" autocomplete="off" autofocus="true" class="form-control"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nomor_telepon_orang_tua" autocomplete="off" class="form-control"
                            placeholder="Masukkan Nomor Telepon Orang Tua">
                    </div>
                    <div class="form-group">
                        <label>Nomor Telepon Orang Dekat</label>
                        <input type="text" name="nomor_telepon_orang_dekat" autocomplete="off" class="form-control"
                            placeholder="Masukkan Nomor Telepon Orang Dekat">
                    </div>
                    <div class="form-group">
    ...
    function show() {
        call('api/mahasiswa/detail/' + mahasiswa_id).done(function(req) {
            if (req.error == true) {
                ...
                $('form#edit [name=nomor_telepon_orang_dekat]').val(mahasiswa
                    .nomor_telepon_orang_dekat);
                ...
                $('form#edit img.foto').attr('src', base_url + '/cdn/img/mahasiswa/' + ((mahasiswa
                    .foto) ? mahasiswa.foto : 'default.png'))
            }
        })
    }
